...
abstract class TestCase extends PHPUnitTestCase {
    ...
    private function define_common_wp_stubs(): void {
        ...
        Monkey\Functions\stubs( [
            ...
            'maybe_unserialize' => static fn( $data ) => is_serialized( $data ) ? unserialize( $data ) : $data,
            'esc_sql'          => static fn( $data ) => is_array( $data ) ? array_map( 'addslashes', $data ) : addslashes( (string) $data ),
            'trailingslashit'  => static fn( $path ) => rtrim( (string) $path, '/\\' ) . '/',
